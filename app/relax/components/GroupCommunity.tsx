...
// 神經霓虹色系（賽博學術風）
const IG_FEATURES = [
  { icon: '📸', titleZh: '每日簽到 Buff', titleEn: 'Daily check-in buff', descZh: '深夜溫書打卡，互相監督唔孤單', descEn: 'Late-night study check-ins — keep each other going', color: '#00F5D4' },
  ...
  { icon: '🎙️', titleZh: '開黑語音房（安靜模式）', titleEn: 'Group voice room (quiet mode)', descZh: '偶爾開群組語音，一齊溫書', descEn: 'Occasional group voice sessions — study together', color: '#00F5D4' },
]

const TAGS = [
  { zh: '🌙 深夜溫書打卡', en: '🌙 Late-night check-ins' },
