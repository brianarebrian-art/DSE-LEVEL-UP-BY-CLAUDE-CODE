...
const QS: Q[] = [
  // ── 先秦政治 ────────────────────────────────────────────────────────────
  { t: 'preqin',
    q: ['春秋時期，若干強大的諸侯以「尊王攘夷」為口號。這個口號的用意是甚麼？',
      'In the Spring and Autumn period several powerful lords adopted the slogan “revere the king and expel the barbarians”. What was its purpose?'],
    o: [['以擁戴周天子之名，取得號令其他諸侯的正當性', 'to claim, in the name of upholding the Zhou king, the legitimacy to command the other lords'],
      ['公開主張廢除周天子，另行擁立新的共主', 'to call openly for deposing the Zhou king and installing a new overlord'],
      ['主張各諸侯國合併為一國，結束分封的局面', 'to propose merging the states into one and ending the enfeoffment system'],
      ['主張把王位讓予外族首領，以換取邊境和平', 'to propose ceding the throne to a non-Zhou leader in exchange for peace on the frontier']],
    e: ['周天子此時實力已經衰微，名分卻仍在。霸主打着尊王的旗號，既不必推翻既有秩序，又可借天子之名召集諸侯、討伐異己，權力因而有了說法。這正是「禮崩樂壞」時期的特徵：舊制度的形式仍在使用，實質卻已被借用來服務新的權力。答題時若只寫「抵抗外族」，便漏掉了「尊王」那一半，而那一半才是政治上的關鍵。',
      'By this time the Zhou king’s power had declined while his standing had not. A hegemon marching under the banner of revering the king need not overturn the existing order, yet could summon the other lords and punish rivals in the king’s name, so that his power acquired a justification. This is characteristic of the period: the forms of the old order remained in use while their substance had been borrowed to serve new power. Writing only about expelling outsiders drops the other half of the slogan — and that half is where the politics lies.'],
  },
  {
    t: 'preqin',
  ...
  // ── 民國發展 ────────────────────────────────────────────────────────────
  { t: 'republic',
    q: ['新文化運動主張以白話文取代文言文。這一主張的主要用意是甚麼？',
      'The New Culture Movement argued for replacing classical Chinese with the vernacular. What was the main intention?'],
    o: [['使書面語接近口語，讓一般人也能讀能寫，思想得以廣泛傳播', 'to bring written language close to speech so ordinary people could read and write, letting ideas spread widely'],
      ['保存古代典籍的原貌，避免後人任意改動文字', 'to preserve ancient texts in their original form against later alteration'],
      ['統一各地方言的讀音，使全國語音趨於一致', 'to unify the pronunciation of regional dialects across the country'],
      ['提高考試的文字難度，以便篩選真正的人才', 'to raise the difficulty of examination prose so as to select genuine talent']],
    e: ['文言與口語長期分家，能讀能寫者只限於少數受過長期訓練的人；改用白話，等於把識字與表達的門檻大幅拉低。新思想若只能以文言傳播，受眾便被限制在原有的士人圈子之內，運動所追求的社會改造亦無從談起。故白話文運動並非單純的文體之爭，而是要換一批能夠參與討論的人。',
      'Classical written Chinese had long been separate from ordinary speech, so reading and writing were confined to the few with years of training; switching to the vernacular lowered that threshold sharply. New ideas carried only in classical prose would have reached no further than the existing scholar class, and the social transformation the movement sought would have been out of reach. The vernacular campaign was therefore not a quarrel about style but an attempt to change who could take part in the argument.'],
  },
  { t: 'republic',
    q: ['五四運動最初由北京的學生發起，其後迅速擴大。這裏所謂「擴大」，具體表現是甚麼？',
      'The May Fourth Movement began with students in Beijing and then spread rapidly. In what did that spreading consist?'],
    o: [['上海等地的工人罷工、商人罷市，運動由學界擴及社會各階層', 'workers struck and merchants closed their shops in Shanghai and elsewhere, carrying the movement beyond the students into other classes'],
      ['各省的軍閥先後宣布獨立，脫離北京政府的管轄', 'provincial warlords declared independence one after another from the Beijing government'],
      ['政府主動下令全國各地響應學生所提出的訴求', 'the government itself ordered the whole country to support the students’ demands'],
      ['各國駐華使館聯合發表聲明，公開支持學生', 'the foreign legations in China issued a joint statement backing the students']],
    e: ['運動之所以能迫使政府讓步，關鍵在於它不再只是校園之內的事：工人罷工影響生產，商人罷市影響市面，壓力由多方同時施加。研究群眾運動時要留意這一點 —— 訴求是否正當是一回事，能否形成足夠壓力是另一回事，而後者往往取決於有多少不同群體加入。',
      'What forced the government to give ground was that the movement ceased to be confined to the campuses: strikes disrupted production and shop closures disrupted commerce, so pressure came from several directions at once. This is worth noting in studying popular movements — whether a demand is just is one question, and whether it can generate sufficient pressure another, and the second usually turns on how many different groups join in.'],
  },
  {
    t: 'republic',
    q: ['一九三六年西安事變的直接結果是甚麼？',
  ...
  // ── 中共建國至改革 ───────────────────────────────────────────────────────
  { t: 'prc',
    q: ['一九五四年，中華人民共和國頒布第一部憲法。這部憲法確立了甚麼為最高國家權力機關？',
      'The People’s Republic promulgated its first constitution in 1954. What did it establish as the highest organ of state power?'],
    o: [['全國人民代表大會', 'the National People’s Congress'],
      ['國務院轄下的各部及委員會', 'the ministries and commissions under the State Council'],
      ['由各省推舉組成的省長會議', 'a council of provincial governors chosen by the provinces'],
      ['重新設立的科舉考試機構', 'a reinstated imperial examination body']],
    e: ['一九五四年憲法把國家的組織形式以成文法確定下來：人民代表大會制度為國家的根本政治制度，全國人民代表大會為最高國家權力機關，國務院則是最高國家行政機關，兩者的層級不可對調。留意科舉早於一九○五年已經停辦，與此期全無關係；把不同時代的制度混在一起，是本科常見的錯。',
      'The 1954 constitution set down the organisation of the state in written law: the people’s congress system is the fundamental political system, the National People’s Congress is the highest organ of state power, and the State Council is the highest organ of state administration; the two levels must not be interchanged. Note that the imperial examinations had been abolished in 1905 and have no bearing on this period at all — mixing institutions from different eras is a common error in this subject.'],
  },
  {
    t: 'prc',
  ...
  { t: 'prc',
    q: ['文化大革命對中國的教育造成一項直接影響。這項影響是甚麼？',
      'The Cultural Revolution had one direct effect on education in China. What was it?'],
    o: [['高等院校一度停止招生，正常教學中斷達數年之久', 'universities stopped admitting students for a time and normal teaching was interrupted for years'],
      ['全面推行九年免費義務教育，入學率大幅上升', 'nine years of free compulsory education was introduced and enrolment rose sharply'],
      ['大量增設研究院所，研究人員數目倍增', 'research institutes were created in quantity and the number of researchers doubled'],
      ['恢復以科舉方式選拔各級官員', 'officials at all levels were again selected by imperial examination']],
    e: ['高考中斷、院校停招、教師與知識分子受衝擊，使一代人的正規教育出現斷層，其後果在人才供應上持續多年。一九七七年恢復高考，正是為了修補這一斷層，故兩件事應連起來理解。留意九年免費教育與研究體系擴充均屬其後的發展，時序不可前置。',
  ...
  { t: 'hktw',
    q: ['香港開埠之後，港英政府把香港闢為「自由港」。這項安排的主要作用是甚麼？',
      'After Hong Kong was opened, the colonial government made it a free port. What did that arrangement mainly achieve?'],
    o: [['船貨進出基本免收關稅，吸引各地商船以此為轉口中心', 'goods moved in and out largely free of customs duty, drawing shipping to use it as an entrepôt'],
      ['向所有入境的居民徵收人頭稅，以增加政府收入', 'a poll tax was levied on all who entered, raising revenue for the government'],
      ['限制外國商船進入，以保障本地商人的利益', 'foreign shipping was restricted so as to protect the interests of local merchants'],
      ['以高關稅保護本地製造業，扶植工業的發展', 'high tariffs protected local manufacturing and fostered the growth of industry']],
    e: ['香港本身資源有限、腹地不大，自由港政策把地理位置的優勢轉化為制度上的優勢：貨物毋須繳付關稅即可轉運，商人自然選擇經此進出。轉口貿易因而成為香港早期經濟的支柱，亦奠定了其後「中介」角色的基礎。留意自由港的邏輯與保護關稅剛好相反，兩者不可混為一談。',
      'Hong Kong had few resources of its own and little hinterland, and free-port policy turned an advantage of position into an advantage of institution: goods could be transhipped without paying duty, so merchants naturally routed them through. Entrepôt trade thus became the mainstay of the early economy and laid the basis for the intermediary role that followed. Note that the logic of a free port is the opposite of protective tariffs, and the two must not be confused.'],
  },
  {
    t: 'hktw',
  ...
  // ── 補足至三十八條（2026-08-21 第二輪） ─────────────────────────────────
  { t: 'lateqing',
    q: ['義和團事件之後，清廷與列強簽訂《辛丑條約》。該條約對清政府造成的最直接影響是甚麼？',
      'After the Boxer episode the Qing court signed the Boxer Protocol with the powers. What was its most direct effect on the Qing government?'],
    o: [['須支付巨額賠款，並容許外國在京畿一帶駐兵', 'it had to pay a vast indemnity and permit foreign troops to be stationed around the capital'],
      ['須把香港島割讓予英國，開啟割地之始', 'it had to cede Hong Kong Island to Britain, beginning the cession of territory'],
      ['須開放五個沿海口岸，准許外商通商居住', 'it had to open five coastal ports to foreign trade and residence'],
      ['須承認朝鮮獨立，放棄對其宗主地位', 'it had to recognise the independence of Korea and give up its suzerainty']],
    e: ['賠款額之巨使清廷財政長期受制，而外國駐兵於京畿更直接削弱其自衞能力，清政府自此在對外事務上愈發被動，這亦是其後新政與立憲之議轉趨迫切的背景。其餘三項均為真實條款，但分屬別的條約：割讓香港島與開放五口出自《南京條約》，承認朝鮮獨立出自《馬關條約》。把條約與條款對錯號，是本課最常見的失分位。',
      'The scale of the indemnity kept Qing finances constrained for years, while foreign troops stationed near the capital directly weakened its capacity for self-defence, leaving the court increasingly passive in external affairs — the background against which the New Policies and constitutional proposals became urgent. The other three are all genuine terms but belong to other treaties: the cession of Hong Kong Island and the opening of five ports come from the Treaty of Nanking, and the recognition of Korean independence from the Treaty of Shimonoseki. Matching terms to the wrong treaty is the commonest slip in this topic.'],
  },
  { t: 'revolution',
    q: ['同盟會於一九○五年在東京成立。它的性質是甚麼？',
      'The Tongmenghui was founded in Tokyo in 1905. What kind of body was it?'],
    o: [['由多個革命團體合併而成的全國性革命組織', 'a nationwide revolutionary organisation formed by merging several revolutionary groups'],
      ['清廷為推行新政而設立的官方機構', 'an official body set up by the Qing court to carry out the New Policies'],
      ['主張保留皇帝而實行君主立憲的改良團體', 'a reformist body advocating a constitutional monarchy with the emperor retained'],
      ['由外國商人在華設立的商業組織', 'a commercial organisation established in China by foreign merchants']],
    e: ['同盟會把興中會、華興會、光復會等分散的革命力量集合起來，並提出綱領與機關報，使革命由各自為戰轉為有共同目標的運動，是辛亥革命得以在多省響應的組織基礎。留意它與立憲派的分別在於【目標】而非手段：立憲派主張保留皇帝而限制其權力，革命派則要推翻帝制另建共和，兩者當時並存而互相論戰，不可混為一談。',
      'The Tongmenghui gathered scattered revolutionary forces such as the Xingzhonghui, Huaxinghui and Guangfuhui, and set out a programme and a party organ, turning separate local efforts into a movement with a shared aim — the organisational basis on which province after province responded in 1911. Note that what separated it from the constitutionalists was the goal rather than the method: the constitutionalists wished to keep the emperor while limiting his power, the revolutionaries to end the monarchy and found a republic. The two coexisted and argued against each other at the time and should not be run together.'],
  },
  { t: 'republic',
    q: ['軍閥割據時期的基本特徵是甚麼？',
      'What characterised the period of warlord division?'],
    o: [['各地軍事實力人物各據地盤，中央政府號令難行', 'military strongmen held their own territories, and the central government’s writ did not run'],
      ['全國由單一政黨統一管治，政令上下貫通', 'a single party governed the whole country and its orders were carried out throughout'],
      ['政權由議會多數黨組成，並按期改選更替', 'government was formed by the majority party in parliament and changed at regular elections'],
      ['地方行政由科舉出身的文官體系全面掌握', 'local administration was wholly in the hands of officials recruited through the examinations']],
    e: ['帝制結束之後，統一的權威未能重建，掌握軍隊者即掌握實權，各據一方而互相攻伐，中央政府雖然名義存在，實際能夠支配的範圍有限。這一局面直接造成賦稅繁重、交通阻斷與民生困苦，亦解釋了為何其後「統一」成為各方共同訴求。留意科舉已於一九○五年停辦，以文官體系描述此期並不符史實。',
      'With the monarchy gone and no unified authority rebuilt, whoever commanded troops held real power; each held a region and fought the others, and though a central government existed in name the area it could actually direct was limited. This produced heavy exactions, broken communications and severe hardship, and explains why unification became a demand shared across the political spectrum thereafter. Note that the examination system had been abolished in 1905, so describing this period in terms of an examination-recruited officialdom does not match the record.'],
  },
]
