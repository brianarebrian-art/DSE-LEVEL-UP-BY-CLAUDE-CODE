...
const RULES = [
  ...
  {
    // 2026-09-23：首頁 demo 三處聲稱展示緊一條【真】2023 DSE 卷一題 ——
    // 「一條 2023 DSE 真題」、「官方試題」、同埋一行 `2023 DSE Math Paper 1 Q1`。
    // 憲章 §1.4：本站所有題目都係原創平行改寫，一條都唔係 HKEAA 原文；
    // 而每頁 footer 同時寫住「並非官方試題」。即係首頁同免責聲明自己打架。
    //
    // 個閘守【類】：任何「引用一條具體官方試題」或者「話自己嘅內容係真題」
    // 嘅寫法。刻意唔攔「官方試題同成績以考評局為準」「官方歷屆試題請前往…」
    // 呢類正確嘅免責句 —— 嗰啲係指向 HKEAA，唔係聲稱自己有。
    // ⚠️ 標籤類只攔【成個字串值就係佢】，唔攔散文：「分析每道官方試題的考核
    //    能力點」係描述改寫方法（睇官方卷抽考點），唔係聲稱自己展示緊官方原文。
    //    第一版規則就係喺呢度誤攔過 methodSteps。
    // ⚠️ 亦【唔】攔單獨一個「歷屆試題」—— 佢有合法用途（SEO keywords、
    //    「官方歷屆試題請前往 HKEAA 網站」）。會誤報嘅閘好快會被人加 allowlist
    //    繞過，搞到成個閘冇人信。要攔嘅係【聲稱自己嗰份係官方】，
    //    所以只留「官方試題」同 Official question 兩個標籤寫法。
    id: 'past-paper-claim',
    re: /20\d{2}\s*(?:HK)?DSE\b[^\n]{0,40}\bQ\s*\d|Paper\s*\d+\s*Q\s*\d|[一呢][條份題][^\n]{0,15}真題|(['"`])\s*(?:Official question|官方試題)\s*\1|\bA real\s+20\d{2}[^\n]{0,20}question\b/gi,
    why: '聲稱展示緊官方／歷屆試題原文。憲章 §1.4 要求全部題目原創平行改寫，footer 亦寫住「並非 HKEAA 官方試題」—— 呢種寫法令兩句自己打架，亦係最直接嘅版權風險。',
    fix: '講返實情：「一個 DSE 常見題型」「原創改寫練習題」。要指去官方試題就寫清楚係 HKEAA 嗰邊嘅嘢（例如「官方歷屆試題請前往 HKEAA 網站」）。',
  },
  {
