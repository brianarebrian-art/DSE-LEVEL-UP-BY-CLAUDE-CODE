...
const zh = {
  ...
  predictor: {
    ...
    activeDays: '近 30 日有練習：{n} 日',
    storyTitle: '逐週正確率',
    storyLead: '每一點係一個完整七日。太快完成嘅節（每題少過 3 秒）唔計 —— 同下面估算用同一條規則。',
    storyEmpty: '最少要有兩個星期有練習，先畫得出一條線。',
    thisWeek: '本週',
    weeksAgo: '{n} 週前',
    causesTitle: '錯因分佈',
    ...
    nextTitle: '下一步',
    nextReview: '重溫你最近答錯嘅題目 —— 分界生欠嗰一兩分，通常就喺嗰度。',
    nextReviewCta: '去重溫',
    nextStart: '揀一科再做一節，估算就會再準少少。',
    nextStartCta: '揀科目',
    emptyTitle: '仲未有練習紀錄',
  ...
  home: {
    ...
    subjectsSubA: ' 科都有改寫 MC 練習；書寫、口試同實作題型未涵蓋',
    roadmapA: '睇晒全部 ',
    roadmapB: ' 科路線圖',
    ctaTitle: '準備好開始？',
  ...
  result: {
    emptyTitle: '呢度未有練習結果',
    emptyBody: '做完一節練習，結果就會喺呢度出現。結果只會存喺呢個瀏覽器入面 —— 換咗部機、用緊無痕模式，或者清咗瀏覽器資料，呢頁都會係空白。你嘅練習紀錄照樣可以喺「我的進度」睇返。',
    emptyStart: '開始一節練習',
    emptyProgress: '睇我的進度',
    mixedResult: ' · 綜合練習成績',
    predictedGrade: '今次表現等級',
    rangeSingle: '以呢 {n} 題計，你嘅水平指向 Level {low}。',
    rangeSpan: '以呢 {n} 題計。考慮到樣本大小，你嘅真實水平大概喺 Level {low} 至 {high} 之間。',
    ...
    cutoffOrigin: '分界線由本平台按歷年分佈估算，並非考評局公布嘅官方分數；題目亦為改寫版本，難度分佈同真卷唔會完全一致。此數僅作自我診斷。',
  ...
  dashboard: {
    title: '我的進度',
    emptyBody: '你仲未開始練習。做完第一份練習後，呢度就會記錄你嘅練習日數、正確率同各科表現。',
    emptyCta: '開始第一份練習',
    subtitleA: '已活躍 ',
    subtitleB: ' 日 · 共答對 ',
    continueP: '繼續練習',
    ...
    statRecentDays: '近 30 日練習',
    statRecentDaysUnit: '日',
    statQuestions: '已練習題數',
    statQuestionsUnit: '題',
    statAccuracy: '整體正確率',
    statAttempts: '練習次數',
...
const en: typeof zh = {
  ...
  predictor: {
    ...
    activeDays: 'Days practised in the last 30: {n}',
    storyTitle: 'Accuracy by week',
    storyLead: 'Each point is a full seven days. Sessions finished too fast (under 3 seconds a question) are left out — the same rule the estimates below use.',
    storyEmpty: 'You need at least two weeks with practice before there is a line to draw.',
    thisWeek: 'This week',
    weeksAgo: '{n}w ago',
    ...
    nextTitle: 'Next step',
    nextReview: 'Go back over the questions you recently got wrong — for a borderline candidate, that is usually where the missing marks are.',
    nextReviewCta: 'Review now',
    nextStart: 'One more session in any subject makes the estimate a little sharper.',
    nextStartCta: 'Choose a subject',
  ...
  practice: {
    ...
    otherSubjects: 'Browse other subjects →',
  },
  auth: {
  ...
  home: {
    ...
    subjectsSubA: ' subjects have rewritten MC practice; written, oral and practical papers are not covered',
  ...
  result: {
    emptyTitle: 'No practice result here yet',
    emptyBody: 'Finish a practice session and your result will appear here. Results are kept only in this browser, so this page is empty on another device, in a private window, or after clearing browser data. Your practice history is still in My Progress.',
    ...
    rangeSingle: 'Based on these {n} questions, your level points to Level {low}.',
    rangeSpan: 'Based on these {n} questions. Allowing for sample size, your true level is likely between Level {low} and {high}.',
    ...
    cutoffOrigin: 'These boundaries are this platform’s estimate from past distributions, not official HKEAA cut-offs; the questions are rewritten versions whose difficulty mix will not match a real paper exactly. Treat this as self-diagnosis only.',
  ...
  dashboard: {
    title: 'My Progress',
    emptyBody: 'You haven’t started practising yet. After your first session, your practice days, accuracy and per-subject performance will show up here.',
    ...
    statRecentDays: 'Practised (last 30d)',
    statRecentDaysUnit: 'days',
