...
//
// 2026-08-29 再調高：數學經平均分佈補強後升至 1,539 條，升穿咗舊值 1500，
// 測試如設計般變紅。呢個閘做咗佢應該做嘅事 —— 題庫長大而輪換窗口冇跟上，
// 係一個學生察覺到（「做嚟做去都係嗰批題」）但開發者睇唔到嘅退化。
//
// 新值 2500：覆蓋現時最大嘅 1,539，亦為「每科 1,000 MC ＋ 100 書寫題」
// 呢個目標留足餘裕（數學已遠超該目標）。
// 儲存代價：2500 個 id × 約 12 bytes ≈ 30KB／科，localStorage 額度綽綽有餘。
//
