 ...
 * ✅ Brian（CEO）2026-09-09 副署 —— 雙簽完成，正式生效（docs/charter.md §16.E 約束 5）。
 *   （原本寫住「⬜ 待 Brian 副署」，副署之後冇人返嚟改。2026-09-25 另一份外部審查
 *   就係讀咗呢句，建議「Brian 補簽或者先暫停上雲」—— 一句過期註釋，差啲令一個
 *   已經生效嘅決定被當成未生效而停咗。以憲章為準。）
