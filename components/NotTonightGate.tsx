        ...
        >
          ...
          <div className="space-y-2.5">
            <button
              ...
              autoFocus
              className="w-full min-h-11 bg-surface-sunken text-accent border border-accent/30 hover:bg-surface-sunken rounded-xl px-4 py-3 text-sm font-medium transition-all"
            >
