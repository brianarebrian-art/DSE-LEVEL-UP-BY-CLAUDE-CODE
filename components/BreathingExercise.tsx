...
export default function BreathingExercise() {
  ...
  return (
    <div className="bg-surface-raised border border-line rounded-2xl p-6 text-center">
      <div className="flex items-center justify-center gap-2 text-ink-soft font-medium mb-4">
      ...
      <div className="flex items-center justify-center h-40 mb-4">
        <div
          className="w-24 h-24 rounded-full bg-accent/15 border border-accent/40 flex items-center justify-center"
          style={{
      ...
      {phase === 'idle' ? (
        ...
        <button
          onClick={stop}
          className="inline-flex items-center gap-2 text-ink-muted hover:text-ink-soft border border-line-strong px-6 py-2.5 rounded-xl transition-all"
        >
