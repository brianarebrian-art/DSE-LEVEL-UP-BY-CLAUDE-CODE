...
const micro: Question[] = [
  ...
  q(id('mi'), T.micro, FW.market, 'hard', 2024, 3,
    C('某商品的需求函數為 P = 20 − 2Q。在 Q = 5 這一點，需求的點彈性等於？（點彈性 = (dQ/dP)·(P/Q)）',
      'A good has demand P = 20 − 2Q. At Q = 5, the point elasticity of demand equals? (point elasticity = (dQ/dP)·(P/Q))'),
    [opt('−1（單位彈性）', '−1 (unit elastic)'),
      opt('−2', '−2'),
      opt('−0.5', '−0.5'),
      opt('−5', '−5')],
    C('由 P = 20 − 2Q 得 Q = 10 − P/2，故 dQ/dP = −1/2。在 Q=5 時 P = 20 − 10 = 10。點彈性 = (−1/2)·(10/5) = (−1/2)(2) = −1，即線性需求中點的單位彈性。\n\n【陷阱】−2 取了斜率 dP/dQ 的倒數搞錯；−0.5 只取了 dQ/dP 忘了乘 P/Q；−5 把 P/Q 算反。',
      'From P = 20 − 2Q, Q = 10 − P/2, so dQ/dP = −1/2. At Q=5, P = 20 − 10 = 10. Point elasticity = (−1/2)·(10/5) = −1 — unit-elastic at the midpoint of a linear demand.\n\n【Trap】 −2 inverts the slope; −0.5 forgets to multiply by P/Q; −5 inverts P/Q.')),
