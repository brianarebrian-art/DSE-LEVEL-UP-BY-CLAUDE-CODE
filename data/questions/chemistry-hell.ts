...
const T = {
  quant: { id: 'chem_hell_quant',        zh: '定量殺著',         en: 'Quantitative killers' },
  re:    { id: 'chem_hell_redox_equil',  zh: '氧化還原與平衡',   en: 'Redox & equilibrium' },
  org:   { id: 'chem_hell_organic',      zh: '有機殺著',         en: 'Organic killers' },
...
const re: Question[] = [
  ...
  q(id('re'), T.re, FW.electron, 'hard', 2023, 3,
    ...
    C('依勒沙特列原理，升溫令平衡向吸熱方向（此處為逆反應）移動，故氨的平衡產率下降。注意：升溫會加快反應「速率」，但對放熱反應而言「產率」反而下降——速率與產率是兩回事，正是此題殺著。\n\n【陷阱】「產率上升」混淆了速率與產率；「不變」「完全停止」都與勒沙特列原理相違。',
