...
export const mathTopics: Topic[] = [
  ...
  { id: 'inequalities', zh: '不等式', en: 'Inequalities', framework: '條件分解', frameworkEn: 'Condition Decomposition', emoji: '🎯', count: 21 },
  { id: 'circles', zh: '圓的幾何特性', en: 'Properties of Circles', framework: '幾何直覺', frameworkEn: 'Geometric Intuition', emoji: '📐', count: 23 },
