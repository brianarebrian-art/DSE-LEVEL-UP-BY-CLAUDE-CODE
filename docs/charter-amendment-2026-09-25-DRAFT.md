# 憲章修訂草案 —— 2026-09-25：取消「真人逐題實名審批」程序（✅ 2026-09-26 已決定）

> **2026-09-26 更新：** Yuna 按憲章 §18 決定「自動入 approved」：新題過機器閘即上線，創辦人事後覆核，
> 有問題用 `scripts/qbank/withdraw.mts` 退回。條文見憲章 §12。以下內容保留作歷史。
